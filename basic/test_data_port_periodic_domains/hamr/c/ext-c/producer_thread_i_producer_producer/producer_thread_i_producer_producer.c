...
Unit base_test_data_port_periodic_domains_producer_thread_i_producer_producer_initialise_(STACK_FRAME_ONLY) {
  ...
  printf("%s: base_test_data_port_periodic_domains_producer_thread_i_producer_producer_initialise_ called\n", component_id);

  // example usage of api setters

  S8 t0 = base_Base_Types_Integer_8_example(SF_LAST);
  api_put_write_port__base_test_data_port_periodic_domains_producer_thread_i_producer_producer(SF t0);

  /* example usage of api loggers. Commented out as the constructed String may be too long
  api_logInfo__base_test_data_port_periodic_domains_producer_thread_i_producer_producer(SF string("Example logInfo"));

  api_logDebug__base_test_data_port_periodic_domains_producer_thread_i_producer_producer(SF string("Example logDebug"));

  api_logError__base_test_data_port_periodic_domains_producer_thread_i_producer_producer(SF string("Example logError"));
  */
}
...
Unit base_test_data_port_periodic_domains_producer_thread_i_producer_producer_timeTriggered_(STACK_FRAME_ONLY) {
  ...
  value = value + 1;
  api_put_write_port__base_test_data_port_periodic_domains_producer_thread_i_producer_producer(SF value);
}
