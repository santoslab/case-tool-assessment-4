...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case TNone_E19B61: return None_E19B61__eq((None_E19B61) t1, (None_E19B61) t2);
    ...
    case TNone_F97B7F: return None_F97B7F__eq((None_F97B7F) t1, (None_F97B7F) t2);
    case TNone_D3113C: return None_D3113C__eq((None_D3113C) t1, (None_D3113C) t2);
    case TSome_240B2F: return Some_240B2F__eq((Some_240B2F) t1, (Some_240B2F) t2);
    case TSome_D29615: return Some_D29615__eq((Some_D29615) t1, (Some_D29615) t2);
    case TSome_13E02D: return Some_13E02D__eq((Some_13E02D) t1, (Some_13E02D) t2);
    case TSome_1CCCBF: return Some_1CCCBF__eq((Some_1CCCBF) t1, (Some_1CCCBF) t2);
    ...
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api: return base_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api__eq((base_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api) t1, (base_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api) t2);
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_Operational_Api: return base_test_data_port_periodic_domains_consumer_thread_i_Operational_Api__eq((base_test_data_port_periodic_domains_consumer_thread_i_Operational_Api) t1, (base_test_data_port_periodic_domains_consumer_thread_i_Operational_Api) t2);
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge: return base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge__eq((base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge) t1, (base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge) t2);
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints: return base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints__eq((base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints) t1, (base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints) t2);
...
B Type__equiv(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case TNone_E19B61: return None_E19B61__equiv((None_E19B61) t1, (None_E19B61) t2);
    ...
    case TNone_F97B7F: return None_F97B7F__equiv((None_F97B7F) t1, (None_F97B7F) t2);
    case TNone_D3113C: return None_D3113C__equiv((None_D3113C) t1, (None_D3113C) t2);
    case TSome_240B2F: return Some_240B2F__equiv((Some_240B2F) t1, (Some_240B2F) t2);
    case TSome_D29615: return Some_D29615__equiv((Some_D29615) t1, (Some_D29615) t2);
    case TSome_13E02D: return Some_13E02D__equiv((Some_13E02D) t1, (Some_13E02D) t2);
    case TSome_1CCCBF: return Some_1CCCBF__equiv((Some_1CCCBF) t1, (Some_1CCCBF) t2);
    ...
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api: return base_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api__equiv((base_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api) t1, (base_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api) t2);
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_Operational_Api: return base_test_data_port_periodic_domains_consumer_thread_i_Operational_Api__equiv((base_test_data_port_periodic_domains_consumer_thread_i_Operational_Api) t1, (base_test_data_port_periodic_domains_consumer_thread_i_Operational_Api) t2);
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge: return base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge__equiv((base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge) t1, (base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge) t2);
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints: return base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints__equiv((base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints) t1, (base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints) t2);
    default: fprintf(stderr, "%s: %d\n", "Unexpected TYPE: ", type); exit(1);
  }
}
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case TNone_E19B61: None_E19B61_cprint((None_E19B61) this, isOut); return;
    ...
    case TNone_F97B7F: None_F97B7F_cprint((None_F97B7F) this, isOut); return;
    case TNone_D3113C: None_D3113C_cprint((None_D3113C) this, isOut); return;
    case TSome_240B2F: Some_240B2F_cprint((Some_240B2F) this, isOut); return;
    case TSome_D29615: Some_D29615_cprint((Some_D29615) this, isOut); return;
    case TSome_13E02D: Some_13E02D_cprint((Some_13E02D) this, isOut); return;
    case TSome_1CCCBF: Some_1CCCBF_cprint((Some_1CCCBF) this, isOut); return;
    ...
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api: base_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api_cprint((base_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api) this, isOut); return;
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_Operational_Api: base_test_data_port_periodic_domains_consumer_thread_i_Operational_Api_cprint((base_test_data_port_periodic_domains_consumer_thread_i_Operational_Api) this, isOut); return;
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge: base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_cprint((base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge) this, isOut); return;
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints: base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints_cprint((base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints) this, isOut); return;
    default: fprintf(stderr, "%s: %d\n", "Unexpected TYPE: ", type); exit(1);
  }
  #endif
}
...
void Type_string_(STACK_FRAME String result, void *this) {
  ...
  switch (type) {
    ...
    case TNone_E19B61: None_E19B61_string_(CALLER result, (None_E19B61) this); return;
    ...
    case TNone_F97B7F: None_F97B7F_string_(CALLER result, (None_F97B7F) this); return;
    case TNone_D3113C: None_D3113C_string_(CALLER result, (None_D3113C) this); return;
    case TSome_240B2F: Some_240B2F_string_(CALLER result, (Some_240B2F) this); return;
    case TSome_D29615: Some_D29615_string_(CALLER result, (Some_D29615) this); return;
    case TSome_13E02D: Some_13E02D_string_(CALLER result, (Some_13E02D) this); return;
    case TSome_1CCCBF: Some_1CCCBF_string_(CALLER result, (Some_1CCCBF) this); return;
    ...
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api: base_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api_string_(CALLER result, (base_test_data_port_periodic_domains_consumer_thread_i_Initialization_Api) this); return;
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_Operational_Api: base_test_data_port_periodic_domains_consumer_thread_i_Operational_Api_string_(CALLER result, (base_test_data_port_periodic_domains_consumer_thread_i_Operational_Api) this); return;
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge: base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_string_(CALLER result, (base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge) this); return;
    case Tbase_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints: base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints_string_(CALLER result, (base_test_data_port_periodic_domains_consumer_thread_i_consumer_consumer_Bridge_EntryPoints) this); return;
    default: fprintf(stderr, "%s: %d\n", "Unexpected TYPE: ", type); exit(1);
  }
}
