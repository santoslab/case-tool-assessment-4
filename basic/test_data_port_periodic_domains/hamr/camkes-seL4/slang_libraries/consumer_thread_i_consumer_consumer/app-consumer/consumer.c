...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "consumer.scala", "base.consumer_thread_i_consumer_consumer.consumer", "<App>", 0);
  ...
  return (int) base_consumer_thread_i_consumer_consumer_consumer_main(SF &t_args);
}