#ifndef SIREUM_H_base_test_data_port_periodic_domains_consumer_thread_i_Api
#define SIREUM_H_base_test_data_port_periodic_domains_consumer_thread_i_Api
...
#define base_test_data_port_periodic_domains_consumer_thread_i_Api__eq(this, other) Type__eq(this, other)
#define base_test_data_port_periodic_domains_consumer_thread_i_Api__ne(this, other) (!Type__eq(this, other))
#define base_test_data_port_periodic_domains_consumer_thread_i_Api__equiv(this, other) Type__equiv(this, other)
#define base_test_data_port_periodic_domains_consumer_thread_i_Api__inequiv(this, other) (!Type__equiv(this, other))
#define base_test_data_port_periodic_domains_consumer_thread_i_Api_cprint(this, isOut) Type_cprint(this, isOut)
...
inline void base_test_data_port_periodic_domains_consumer_thread_i_Api_string_(STACK_FRAME String result, base_test_data_port_periodic_domains_consumer_thread_i_Api this) {
