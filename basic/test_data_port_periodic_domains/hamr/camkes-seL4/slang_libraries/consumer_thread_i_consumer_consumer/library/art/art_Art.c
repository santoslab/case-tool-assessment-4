...
Unit art_Art_logInfo(STACK_FRAME art_Art_BridgeId bridgeId, String msg) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(101);
    {
      ...
      base_consumer_thread_i_consumer_consumer_consumer_logInfo(SF (String) ((String) &t_5), (String) msg);
    }
  } else {

    sfUpdateLoc(103);
    {
      base_consumer_thread_i_consumer_consumer_consumer_logInfo(SF (String) string(""), (String) msg);
    }
  }
}
...
Unit art_Art_logDebug(STACK_FRAME art_Art_BridgeId bridgeId, String msg) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(117);
    {
      ...
      DeclNewString(t_5);
      art_Bridge_name_(SF (String) &t_5, ((art_Bridge) &t_4));
      base_consumer_thread_i_consumer_consumer_consumer_logDebug(SF (String) ((String) &t_5), (String) msg);
    }
  } else {

    sfUpdateLoc(119);
    {
      base_consumer_thread_i_consumer_consumer_consumer_logDebug(SF (String) string(""), (String) msg);
    }
  }
}
...
Unit art_Art_logError(STACK_FRAME art_Art_BridgeId bridgeId, String msg) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(109);
    {
      ...
      DeclNewString(t_5);
      art_Bridge_name_(SF (String) &t_5, ((art_Bridge) &t_4));
      base_consumer_thread_i_consumer_consumer_consumer_logError(SF (String) ((String) &t_5), (String) msg);
    }
  } else {

    sfUpdateLoc(111);
    {
      base_consumer_thread_i_consumer_consumer_consumer_logError(SF (String) string(""), (String) msg);
    }
  }
}
...
void art_Art_getValue(STACK_FRAME Option_8E9F45 result, art_Art_PortId portId) {
  ...
  base_consumer_thread_i_consumer_consumer_consumer_getValue(SF (Option_8E9F45) &t_0, portId);
...
Unit art_Art_sendOutput(STACK_FRAME IS_D10119 eventPortIds, IS_D10119 dataPortIds) {
  ...
  sfUpdateLoc(92);
  {
    base_consumer_thread_i_consumer_consumer_consumer_sendOutput(SF (IS_D10119) eventPortIds, (IS_D10119) dataPortIds);
  }
}
...
Unit art_Art_receiveInput(STACK_FRAME IS_D10119 eventPortIds, IS_D10119 dataPortIds) {
  ...
  sfUpdateLoc(80);
  {
    base_consumer_thread_i_consumer_consumer_consumer_receiveInput(SF (IS_D10119) eventPortIds, (IS_D10119) dataPortIds);
  }
}
