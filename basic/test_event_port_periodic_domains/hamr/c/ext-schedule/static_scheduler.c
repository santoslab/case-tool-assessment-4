...
__attribute__((weak)) art_scheduling_static_Schedule_DScheduleSpec base_Schedulers_defaultStaticSchedule(STACK_FRAME_ONLY);
...
void base_ScheduleProviderI_getStaticSchedule(STACK_FRAME art_scheduling_static_Schedule_DScheduleSpec result){
  ...
  if(base_Schedulers_defaultStaticSchedule) {
    ...
    art_scheduling_static_Schedule_DScheduleSpec schedule = base_Schedulers_defaultStaticSchedule(SF_LAST);
