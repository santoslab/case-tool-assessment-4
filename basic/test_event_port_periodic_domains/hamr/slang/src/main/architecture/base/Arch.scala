...
object Arch {
  val top_impl_Instance_producer_producer : base.test_event_port_periodic_domains.producer_t_i_producer_producer_Bridge = {
    val emit = Port[art.Empty] (id = portId"0", name = "top_impl_Instance_producer_producer_emit", mode = EventOut)
  ...
  val top_impl_Instance_consumer_consumer : base.test_event_port_periodic_domains.consumer_t_i_consumer_consumer_Bridge = {
    val consume = Port[art.Empty] (id = portId"1", name = "top_impl_Instance_consumer_consumer_consume", mode = EventIn)
  ...
  val ad : ArchitectureDescription = {
    ...
    ArchitectureDescription(
      ...
      connections = IS[Art.ConnectionId, UConnection] (Connection(from = top_impl_Instance_producer_producer.emit, to = top_impl_Instance_consumer_consumer.consume))
    )
  }
}
