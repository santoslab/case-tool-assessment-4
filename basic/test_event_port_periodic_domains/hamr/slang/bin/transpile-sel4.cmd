...
val producer_t_i_producer_producer: ISZ[String] = ISZ(
  "--sourcepath", s"${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/base/test_event_port_periodic_domains${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/base/producer_t_i_producer_producer",
  "--output-dir", s"${SCRIPT_HOME}/../../camkes-seL4/slang_libraries/producer_t_i_producer_producer",
...
val consumer_t_i_consumer_consumer: ISZ[String] = ISZ(
  "--sourcepath", s"${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/base/test_event_port_periodic_domains${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/base/consumer_t_i_consumer_consumer",
  "--output-dir", s"${SCRIPT_HOME}/../../camkes-seL4/slang_libraries/consumer_t_i_consumer_consumer",
...
val SlangTypeLibrary: ISZ[String] = ISZ(
  ...
  "--output-dir", s"${SCRIPT_HOME}/../../camkes-seL4/slang_libraries/SlangTypeLibrary",
