...
//   IS[Z,art.UPort]=1 - Needed for producer's eventOuts ports
  ...
  case Some(o: Cli.TranspileOption) =>
    if(o.legacy) {
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--string-size", "256",
        "--sequence-size", "1",
        "--sequence", s"MS[Z,Option[art.Bridge]]=2;IS[Z,String]=3;IS[Z,art.Art.PortId]=1;IS[Z,art.UPort]=1",
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--string-size", "256",
        "--sequence-size", "1",
        "--sequence", s"MS[Z,Option[art.Bridge]]=2;IS[Z,String]=3;IS[Z,art.Art.PortId]=1;IS[Z,art.UPort]=1;IS[Z,(Z,art.ArtSlangMessage)]=5;IS[Z,art.Art.BridgeId]=2;IS[Z,art.scheduling.static.Schedule.Slot]=2;IS[Z,(String,art.Art.BridgeId)]=2",
        "--constants", s"art.Art.numComponents=2;art.Art.numPorts=5;art.Art.numConnections=1",
