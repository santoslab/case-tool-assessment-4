...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case TNone_5A630D: return sizeof(struct None_5A630D); // None[base.test_event_port_periodic_domains.producer_t_i_Initialization_Api]
    case TNone_04C60E: return sizeof(struct None_04C60E); // None[base.test_event_port_periodic_domains.producer_t_i_Operational_Api]
    case TSome_D29615: return sizeof(struct Some_D29615); // Some[art.DataContent]
    case TSome_4CD075: return sizeof(struct Some_4CD075); // Some[base.test_event_port_periodic_domains.producer_t_i_Initialization_Api]
    case TSome_A8A5E0: return sizeof(struct Some_A8A5E0); // Some[base.test_event_port_periodic_domains.producer_t_i_Operational_Api]
    ...
    case Tbase_test_event_port_periodic_domains_producer_t_i_Initialization_Api: return sizeof(struct base_test_event_port_periodic_domains_producer_t_i_Initialization_Api); // base.test_event_port_periodic_domains.producer_t_i_Initialization_Api
    case Tbase_test_event_port_periodic_domains_producer_t_i_Operational_Api: return sizeof(struct base_test_event_port_periodic_domains_producer_t_i_Operational_Api); // base.test_event_port_periodic_domains.producer_t_i_Operational_Api
    case Tbase_test_event_port_periodic_domains_producer_t_i_producer_producer_Bridge: return sizeof(struct base_test_event_port_periodic_domains_producer_t_i_producer_producer_Bridge); // base.test_event_port_periodic_domains.producer_t_i_producer_producer_Bridge
    case Tbase_test_event_port_periodic_domains_producer_t_i_producer_producer_Bridge_EntryPoints: return sizeof(struct base_test_event_port_periodic_domains_producer_t_i_producer_producer_Bridge_EntryPoints); // base.test_event_port_periodic_domains.producer_t_i_producer_producer_Bridge.EntryPoints
