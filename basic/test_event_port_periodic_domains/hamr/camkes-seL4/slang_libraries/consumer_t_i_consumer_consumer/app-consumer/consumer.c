...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "consumer.scala", "base.consumer_t_i_consumer_consumer.consumer", "<App>", 0);
  ...
  return (int) base_consumer_t_i_consumer_consumer_consumer_main(SF &t_args);
}