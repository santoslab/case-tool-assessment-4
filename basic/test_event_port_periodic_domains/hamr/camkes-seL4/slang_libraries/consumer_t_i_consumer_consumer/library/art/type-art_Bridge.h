...
union art_Bridge {
  TYPE type;
  struct base_test_event_port_periodic_domains_consumer_t_i_consumer_consumer_Bridge base_test_event_port_periodic_domains_consumer_t_i_consumer_consumer_Bridge;
};
