...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "SlangTypeLibrary.scala", "base.SlangTypeLibrary.SlangTypeLibrary", "<App>", 0);
  ...
  return (int) base_SlangTypeLibrary_SlangTypeLibrary_main(SF &t_args);
}