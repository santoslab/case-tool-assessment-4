...
void base_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer_Bridge_apply(STACK_FRAME base_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer_Bridge this, art_Art_BridgeId id, String name, art_DispatchPropertyProtocol dispatchProtocol, Option_0247A1 dispatchTriggers, art_Port_A2C07C read_port) {
  ...
  }
  {
    sfUpdateLoc(31);
    {
      ...
      base_test_event_data_port_periodic_domains_consumer_t_i_Initialization_Api_apply(SF &t_5, base_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer_Bridge_id_(this), art_Port_A2C07C_id_(base_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer_Bridge_read_port_(this)));
  ...
  }
  {
    sfUpdateLoc(40);
    {
      ...
      base_test_event_data_port_periodic_domains_consumer_t_i_Operational_Api_apply(SF &t_7, base_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer_Bridge_id_(this), art_Port_A2C07C_id_(base_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer_Bridge_read_port_(this)));
