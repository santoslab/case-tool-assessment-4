...
object producer_t_i_producer_producer_App extends App {
  ...
  def touch(): Unit = {
    if(F) {
      ...
      base.test_event_data_port_periodic_domains.producer_t_i_producer_producer_Bridge.c_initialization_api.get.put_write_port(Base_Types.Integer_8_example())
      base.test_event_data_port_periodic_domains.producer_t_i_producer_producer_Bridge.c_operational_api.get.put_write_port(Base_Types.Integer_8_example())
    }
  }
