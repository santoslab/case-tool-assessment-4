...
object Arch {
  val top_impl_Instance_producer_producer : base.test_event_data_port_periodic_domains.producer_t_i_producer_producer_Bridge = {
    val write_port = Port[Base_Types.Integer_8] (id = portId"0", name = "top_impl_Instance_producer_producer_write_port", mode = EventOut)
  ...
  val top_impl_Instance_consumer_consumer : base.test_event_data_port_periodic_domains.consumer_t_i_consumer_consumer_Bridge = {
    val read_port = Port[Base_Types.Integer_8] (id = portId"1", name = "top_impl_Instance_consumer_consumer_read_port", mode = EventIn)
