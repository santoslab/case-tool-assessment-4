...
object Schedulers {
  ...
  val threadNickNames: Map[String, Art.BridgeId] = Map(
    ISZ(
      Arch.top_impl_Instance_producer_producer.name ~> Arch.top_impl_Instance_producer_producer.id,
      Arch.top_impl_Instance_consumer_consumer.name ~> Arch.top_impl_Instance_consumer_consumer.id)
  )
  ...
  val top_impl_Instance_producer_producer_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = Some((10, 10)),
    domain = Some(2))

  val top_impl_Instance_consumer_consumer_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = Some((10, 10)),
    domain = Some(3))
  ...
  val defaultDomainToBridgeIdMap: ISZ[Art.BridgeId] = ISZ(
    /* domain 0 */ Arch.top_impl_Instance_producer_producer.id,
    /* domain 1 */ Arch.top_impl_Instance_consumer_consumer.id
  )
