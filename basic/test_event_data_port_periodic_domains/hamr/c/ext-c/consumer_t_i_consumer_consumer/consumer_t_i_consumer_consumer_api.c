...
static struct base_test_event_data_port_periodic_domains_consumer_t_i_Initialization_Api initialization_api;
static struct base_test_event_data_port_periodic_domains_consumer_t_i_Operational_Api operational_api;
...
static void initialize_apis(STACK_FRAME_ONLY) {
  ...
  Option_0CB775_get_(SF (base_test_event_data_port_periodic_domains_consumer_t_i_Initialization_Api) &initialization_api, base_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer_Bridge_c_initialization_api(SF_LAST));
  // Option_F1A21C = Option[base.test_event_data_port_periodic_domains.consumer_t_i_Operational_Api]
  Option_F1A21C_get_(SF (base_test_event_data_port_periodic_domains_consumer_t_i_Operational_Api) &operational_api, base_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer_Bridge_c_operational_api(SF_LAST));
