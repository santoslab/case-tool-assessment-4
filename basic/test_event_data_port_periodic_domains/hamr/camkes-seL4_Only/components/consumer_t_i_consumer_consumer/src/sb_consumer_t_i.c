...
void sb_entrypoint_period_consumer_t_i(int64_t *in_arg) {
...
/************************************************************************
 *  sb_entrypoint_consumer_t_i_consumer_consumer_initializer:
 *
 ...
 *
 ************************************************************************/
void sb_entrypoint_consumer_t_i_consumer_consumer_initializer(const int64_t * in_arg) {
  init((int64_t *) in_arg);
}
...
int run(void) {
  {
    int64_t sb_dummy;
    sb_entrypoint_consumer_t_i_consumer_consumer_initializer(&sb_dummy);
  }
  ...
  for(;;) {
    ...
    {
      int64_t sb_dummy = 0;
      sb_entrypoint_period_consumer_t_i(&sb_dummy);
    }
    sb_self_pacer_tick_emit();
  }
  return 0;
