...
//   IS[Z,art.Art.PortId]=1 - Needed for the sending and receiving of messages in ART and the bridges
//   IS[Z,art.UPort]=1 - Needed for producer's dataOuts ports
//   IS[Z,B]=8 - Needed for the max bit size specified in the model -- see Base_Types::Integer_8
//   IS[Z,(Z,art.ArtSlangMessage)]=5 - Needed for the backing store of Map[Z, ArgSlangMessage] in ArtNativeSlang
  ...
  case Some(o: Cli.TranspileOption) =>
    if(o.legacy) {
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--name", "main",
        "--apps", "base.producer_t_i_producer_producer_App,base.consumer_t_i_consumer_consumer_App,base.LegacyDemo",
        "--fingerprint", "3",
        "--bits", "32",
        "--string-size", "256",
        "--sequence-size", "1",
        "--sequence", s"MS[Z,Option[art.Bridge]]=2;IS[Z,String]=3;IS[Z,art.Art.PortId]=1;IS[Z,art.UPort]=1;IS[Z,B]=8",
        "--constants", s"art.Art.numComponents=2;art.Art.numPorts=5;art.Art.numConnections=1",
        "--forward", "art.ArtNative=base.ArtNix,base.PlatformComm=base.PlatformCommNix",
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--string-size", "256",
        "--sequence-size", "1",
        "--sequence", s"MS[Z,Option[art.Bridge]]=2;IS[Z,String]=3;IS[Z,art.Art.PortId]=1;IS[Z,art.UPort]=1;IS[Z,B]=8;IS[Z,(Z,art.ArtSlangMessage)]=5;IS[Z,art.Art.BridgeId]=2;IS[Z,art.scheduling.static.Schedule.Slot]=2;IS[Z,(String,art.Art.BridgeId)]=2",
        "--constants", s"art.Art.numComponents=2;art.Art.numPorts=5;art.Art.numConnections=1",
