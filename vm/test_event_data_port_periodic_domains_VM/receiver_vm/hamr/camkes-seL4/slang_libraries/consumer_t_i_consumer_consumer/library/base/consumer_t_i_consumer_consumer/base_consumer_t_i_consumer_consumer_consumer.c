...
Unit base_consumer_t_i_consumer_consumer_consumer_touch(STACK_FRAME_ONLY) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(109);
    Option_30119F apiUsage_read_port;
    ...
    base_test_event_data_port_periodic_domains_consumer_t_i_Operational_Api_get_read_port_(SF (Option_30119F) &t_15, ((base_test_event_data_port_periodic_domains_consumer_t_i_Operational_Api) &t_14));
    apiUsage_read_port = (Option_30119F) ((Option_30119F) &t_15);
  }
}
...
void base_consumer_t_i_consumer_consumer_consumer_init_consumerBridge(STACK_FRAME_ONLY) {
  ...
  sfUpdateLoc(18);
  {
    ...
    sfUpdateLoc(19);
    art_Port_45E54D read_port;
    DeclNewart_Port_45E54D(t_0);
    art_Port_45E54D_apply(SF &t_0, art_Art_PortId_C(0), (String) string("top_impl_Instance_consumer_consumer_read_port"), art_PortMode_Type_EventIn);
    read_port = (art_Port_45E54D) (&t_0);
    ...
    base_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer_Bridge_apply(SF &t_1, art_Art_BridgeId_C(0), (String) string("top_impl_Instance_consumer_consumer"), (art_DispatchPropertyProtocol) (&t_2), (Option_0247A1) (&t_3), (art_Port_45E54D) read_port);
...
void base_consumer_t_i_consumer_consumer_consumer_init_read_port_id(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(35);
  _base_consumer_t_i_consumer_consumer_consumer_read_port_id = art_Port_45E54D_id_(base_test_event_data_port_periodic_domains_consumer_t_i_consumer_consumer_Bridge_read_port_(base_consumer_t_i_consumer_consumer_consumer_consumerBridge(SF_LAST)));
};
