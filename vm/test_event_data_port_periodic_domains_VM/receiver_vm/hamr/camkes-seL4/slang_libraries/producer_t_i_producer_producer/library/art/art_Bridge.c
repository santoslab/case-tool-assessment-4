...
B art_Bridge__is(STACK_FRAME void *this) {
  switch(((Type) this)->type) {
    case Tbase_test_event_data_port_periodic_domains_producer_t_i_producer_producer_Bridge: return T;
    default: return F;
  }
}
...
art_Bridge art_Bridge__as(STACK_FRAME void *this) {
  switch(((Type) this)->type) {
    case Tbase_test_event_data_port_periodic_domains_producer_t_i_producer_producer_Bridge: break;
    default:
