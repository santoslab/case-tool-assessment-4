...
B base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api__ne(base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api this, base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api other);
B base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api__inequiv(base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api this, base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api other);
...
void base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api_string_(STACK_FRAME String result, base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api this) {
  DeclNewStackFrame(caller, "producer_t_i_Api.scala", "base.test_event_data_port_periodic_domains.producer_t_i_Operational_Api", "string", 0);
...
B base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api__is(STACK_FRAME void* this);
base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api__as(STACK_FRAME void *this);
...
void base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api_apply(STACK_FRAME base_test_event_data_port_periodic_domains_producer_t_i_Operational_Api this, art_Art_BridgeId id, art_Art_PortId write_port_Id) {
  DeclNewStackFrame(caller, "producer_t_i_Api.scala", "base.test_event_data_port_periodic_domains.producer_t_i_Operational_Api", "apply", 0);
  this->id = id;
