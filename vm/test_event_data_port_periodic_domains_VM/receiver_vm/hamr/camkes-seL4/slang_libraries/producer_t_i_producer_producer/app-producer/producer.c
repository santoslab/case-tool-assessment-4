...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "producer.scala", "base.producer_t_i_producer_producer.producer", "<App>", 0);
  ...
  return (int) base_producer_t_i_producer_producer_producer_main(SF &t_args);
}